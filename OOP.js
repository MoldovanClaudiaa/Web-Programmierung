...
//     } else {
//         selectedBtn.classList.add("incoreect");
//     }
...
function selectAnswer(e) {
    ...
    if (isCorrect) {
        ...
        selectedButton.classList.add("incorrect"); // Corrected the class name from "incoreect" to "incorrect"
    }
    ...
    Array.from(answerButtons.children).forEach(button => {
        if (button.dataset.correct === "true") {
            ...
            button.classList.add("incorrect"); // Ensure incorrect answers are also visually indicated
        }
        button.disabled = true;
    });
